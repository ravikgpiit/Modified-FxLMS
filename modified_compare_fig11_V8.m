...
% visualization
rms_style  = '-b';
rms_legend = 'C_{2} = 0.050, \beta = 0.5, C_{1} = 0.25, U = 0.4 ';
...
rms_style  = '--b';
rms_legend = 'No control at C_{2} = 0.050, C_{1} = 0.25, U = 0.4';
...
% visualization
rms_style  = '-r';
rms_legend = 'C_{2} = 0.075, \beta = 0.5, C_{1} = 0.25, U = 0.4';
...
rms_style  = '--r';
rms_legend = 'No control at C_{2} = 0.075, C_{1} = 0.25, U = 0.4';
...
% visualization
rms_style  = '-g';
rms_legend = 'C_{2} = 0.025, \beta = 0.5, C_{1} = 0.25, U = 0.4';
...
rms_style  = '--g';
rms_legend = 'No control at C_{2} = 0.025, C_{1} = 0.25, U = 0.4';
