...
xlabel('Streamwise x location'); ylabel('v_{rms}'); grid on
legend('R = 1000')
hold on
v_rms1 = xlsread('validation2.xlsx');
semilogy(v_rms1(:,1),v_rms1(:,2),'-*r','linewidth',1);
legend('v_{rms}','Fabbiane DNS data')
